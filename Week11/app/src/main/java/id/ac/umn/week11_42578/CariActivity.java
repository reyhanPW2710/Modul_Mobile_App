...
public class CariActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNimCari = (EditText) findViewById(R.id.etNimCari); etNamaCari = (EditText) findViewById(R.id.etNamaCari);
        etHasilCari = (EditText) findViewById(R.id.etHasilCari); etHasilCari.setEnabled(false);
        ...
        btnCari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nim.isEmpty() || !nama.isEmpty()) {
                    ...
                    etHasilCari.setText(
                            "NIM dan/atau NAMA harus ada yang diisi");
                }
            }
        });
    }
